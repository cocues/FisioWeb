...
<!-- Cargamos Chart.js solo en esta página -->
@section('scripts')
    ...
    function initChart() {
        ...
        progressChart = new Chart(ctx, {
            ...
            options: {
                ...
                scales: {
                    y: { beginAtZero: true, grid: { color: '#F3F4F6', drawBorder: false }, border: { dash: [4, 4] } },
