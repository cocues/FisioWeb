...
<div class="max-w-7xl mx-auto px-6 py-12 md:py-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center animate-[fadeIn_0.5s_ease-out]">
    ...
    <div>
        ...
        <h1 class="text-5xl md:text-6xl font-serif text-fisiogreen font-normal leading-[1.1] tracking-tight mb-6">
            Tu guía digital <br>hacia una <br>recuperación <br>real.
        </h1>
        
        <p class="text-gray-500 text-lg mb-8 max-w-md leading-relaxed">
            FisioWeb reúne ejercicios terapéuticos, cuestionarios de síntomas, seguimiento de progreso y contenido educativo en una sola plataforma.
        </p>
        
        <div class="flex flex-wrap items-center gap-4">
            <!-- NOTA: Botones con rutas reales -->
    ...
    <div class="relative w-full h-[500px] rounded-2xl overflow-hidden shadow-xl">
        ...
        <div class="absolute bottom-6 right-6 bg-white p-4 rounded-xl shadow-lg w-48 animate-[slideIn_0.8s_ease-out]">
